...
//
//
// public class pntLinePos_feeder {
...
//             f_measure++;
//         } while (!myPntLinePos.producesError(d1, d2, d3, d4, d5, d6));
//         return f_measure;
//     }
//
...
//             if (myPntLinePos.producesError(d1, d2, d3, d4, d5, d6)) {
//                 break;
//             }
...
//         String fileName = "PntLinePoskdfc&hnsw.txt";
