...
public class PntLinePosFeeder {
    public static double[][] bd = {{-25, 25}, {-25, 25}, {-25, 25}, {-25, 25}, {-25, 25}, {-25, 25}};
    public static int d1, d2, d3, d4, d5, d6;
    public static double theta = 0.000728;
    private static PntLinePos myPntLinePos = new PntLinePos();
    ...
    private static long[] randomTesting(long mySeed, BufferedWriter writer) throws IOException {
        ...
        while (true) {
            ...
            boolean revealFailure = myPntLinePos.producesError(d1, d2, d3, d4, d5, d6);
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("PntLinePosRT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("PntLinePosFSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("PntLinePosLimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("PntLinePosHNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        PntLinePosFeeder myPntLinePosFeeder = new PntLinePosFeeder();
        boolean seedOpt = false;
        myPntLinePosFeeder.SimRunner(simulations, seedOpt);
