...
//
//
// public class golden_feeder_bk {
//     public static double[] min = {-100, -100, -100};
//     public static double[] max = {60, 60, 60};
//     public static int[][] bd = {{-100, 60}, {-100, 60}, {-100, 60}};
...
//
//         while (true) {
//             double x = min[0] + (max[0] - min[0]) * rng.nextDouble();
//             double y = min[1] + (max[1] - min[1]) * rng.nextDouble();
//             double z = min[2] + (max[2] - min[2]) * rng.nextDouble();
//             f_measure++;
...
//         golden_feeder_bk PogramInstance = new golden_feeder_bk();
//         Sender mySender = (Sender) Native.load(DLL_PATH, Sender.class);
//
//         int selected;
...
//             // System.out.print(selected_set.get(f_measure - 1).toString());
//             if (mySender.Produces_Error(x, y, z)) {
//                 break;
//             }
//         }
