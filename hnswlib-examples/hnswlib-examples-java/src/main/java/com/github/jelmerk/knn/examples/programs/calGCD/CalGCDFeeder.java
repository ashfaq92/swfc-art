...
public class CalGCDFeeder {
    private static int[][] bd = {{1, 1000}, {1, 1000}, {1, 1000}, {1, 1000}, {1, 1000},
            {1, 1000}, {1, 1000}, {1, 1000}, {1, 1000}, {1, 1000}};
    private static int d1, d2, d3, d4, d5, d6, d7, d8, d9, d10;
    public static double theta = 0.0001;
    private static CalGCD myCalGCD = new CalGCD();
    ...
    private static long[] randomTesting(long mySeed, BufferedWriter writer) throws IOException {
        ...
        while (true) {
            ...
            boolean revealFailure = myCalGCD.producesError(d1, d2, d3, d4, d5, d6, d7, d8, d9, d10);
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("CalGCDRT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("CalGCDFSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("CalGCDLimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("CalGCDHNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        CalGCDFeeder myCalGCDFeeder = new CalGCDFeeder();
        boolean seedOpt = false;
        myCalGCDFeeder.SimRunner(simulations, seedOpt);
