...
public class NN_4D_Static {
    private static TestCase randomCreateTc(Random rng) {
        ...
        return new TestCase(id, new double[] { d1, d2, d3, d4 });
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int givenEf : efPool) {
            ...
            int size = 100; // Size of Random TestCases Dataset
            ...
            HnswIndex<Integer, double[], TestCase, Double> hnswIndex = HnswIndex
                    .newBuilder(DistanceFunctions.DOUBLE_EUCLIDEAN_DISTANCE, random_points.size()).withM(9)
            ...
            int[] kPool = { 1, 10}; // No. of nearest neighbors to find
