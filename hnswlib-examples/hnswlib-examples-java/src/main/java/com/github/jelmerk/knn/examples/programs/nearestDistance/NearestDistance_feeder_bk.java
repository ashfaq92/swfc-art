...
//
//
// public class NearestDistance_feeder_bk {
//     public static int[][] bd = {{1, 15}, {1, 15}, {1, 15}, {1, 15}, {1, 15}, {1, 15}, {1, 15}, {1, 15}, {1, 15}, {1, 15}};
...
//             f_measure++;
//         } while (!myNearestDistance.producesError(d1, d2, d3, d4, d5, d6, d7, d8, d9, d10));
//         return f_measure;
//     }
//
...
//             if (myNearestDistance.producesError(d1, d2, d3, d4, d5, d6, d7, d8, d9, d10)) {
//                 break;
//             }
...
//         int f_measure;
//         long f_time;
//         String fileName = "nearestDistance.txt";
