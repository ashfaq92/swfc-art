...
//         int f_measure = 1;
//         while (mySender.tanh(tc) == mySender.tanhm(tc)) {
//             f_measure++;
...
//         if (mySender.tanh(x) != mySender.tanhm(x)) {
//             return generatedNum;
//         }
//         do {
...
//
//         if (mySender.tanh(p.vector[0]) != mySender.tanhm(p.vector[0])) {
//             return kdfc.size;
//         }
//
//         Point finalCase;
...
//         tanh_feeder PogramInstance = new tanh_feeder();
//         Sender mySender = (Sender) Native.load(DLL_PATH, Sender.class);
//
//         int selected;
...
//             f_measure++;
//             if (mySender.tanh(selected_set.get(f_measure - 1).vector[0]) != mySender.tanhm(selected_set.get(f_measure - 1).vector[0])) {
//                 break;
//             }
//         }
//         return f_measure;
