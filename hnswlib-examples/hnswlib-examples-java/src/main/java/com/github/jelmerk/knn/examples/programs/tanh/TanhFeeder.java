package com.github.jelmerk.knn.examples.programs.tanh;
...
public class TanhFeeder {
    public static double[][] bd = {{-500, 500}};
    public static double theta = 0.001817;
    public static String DLL_PATH = "C:\\Users\\Muhammad Ashfaq\\OneDrive\\Programming\\hnswlib-master-java\\hnswlib-examples\\hnswlib-examples-java\\src\\main\\java\\com\\github\\jelmerk\\knn\\examples\\programs\\tanh\\dpt_tanh.dll";

    public interface Sender extends Library {
        double tanh(double n);
        double tanhm(double n);
    }
    ...
    private static long[] randomTesting(long mySeed, BufferedWriter writer) throws IOException {
        ...
        while (true) {
            ...
            boolean revealFailure = mySender.tanh(x) != mySender.tanhm(x);
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("TanhRT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("TanhFSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("TanhLimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("TanhHNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        TanhFeeder myTanhFeeder = new TanhFeeder();
        boolean seedOpt = false;
        myTanhFeeder.SimRunner(simulations, seedOpt);
        System.out.println("---Tanh END---");
    }
}