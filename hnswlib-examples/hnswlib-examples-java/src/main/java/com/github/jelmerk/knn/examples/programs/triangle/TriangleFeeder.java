...
import com.github.jelmerk.knn.examples.programs.pntLinePos.PntLinePos;
...
public class TriangleFeeder {
    ...
    private static long[] randomTesting(long mySeed, BufferedWriter writer) throws IOException {
        ...
        while (true) {
            ...
            boolean revealFailure = myTriangle.producesError(d1, d2, d3, d4, d5, d6);
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("TriangleRT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("TriangleFSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("TriangleLimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("TriangleHNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        TriangleFeeder myTriangleFeeder = new TriangleFeeder();
        boolean seedOpt = false;
        myTriangleFeeder.SimRunner(simulations, seedOpt);
