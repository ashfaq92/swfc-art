...
public class CalDayFeeder {
    public static int[][] bd = {{1, 12}, {1, 31}, {1, 12}, {1, 31}, {1800, 2200}};
    public static int d1, d2, d3, d4, d5;
    public static double theta = 0.000632;
    private static CalDay myCalDay = new CalDay();
    ...
    private static long[] randomTesting(long mySeed, BufferedWriter writer) throws IOException {
        ...
        while (true) {
            ...
            fMeasure++;
            int d1 = (int) tc.vector[0];
            int d2 = (int) tc.vector[1];
            int d3 = (int) tc.vector[2];
            int d4 = (int) tc.vector[3];
            int d5 = (int) tc.vector[4];
            start = System.nanoTime();
            boolean revealFailure = myCalDay.producesError(d1, d2, d3, d4, d5);
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("CalDayRT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("CalDayFSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("CalDayLimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("CalDayHNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        CalDayFeeder myCalDayFeeder = new CalDayFeeder();
        boolean seedOpt = false;
        myCalDayFeeder.SimRunner(simulations, seedOpt);
