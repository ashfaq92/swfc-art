...
import com.github.jelmerk.knn.examples.programs.pntTrianglePos.PntTrianglePos;
...
public class TwoLinesPosFeeder {
    public static double[][] bd = {{-15, 15}, {-15, 15}, {-15, 15}, {-15, 15}, {-15, 15}, {-15, 15}, {-15, 15}, {-15, 15}};
    public static int d1, d2, d3, d4, d5, d6, d7, d8;
    public static double theta = 0.000133;
    private static TwoLinesPos myTwoLinesPos = new TwoLinesPos();
    ...
    private static long[] randomTesting(long mySeed, BufferedWriter writer) throws IOException {
        ...
        while (true) {
            ...
            boolean revealFailure = myTwoLinesPos.producesError(d1, d2, d3, d4, d5, d6, d7, d8);
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("TwoLinesPosRT2"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("TwoLinesPosFSCS2"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("TwoLinesPosLimBalKdfc3"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("TwoLinesPosHNSW2"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        TwoLinesPosFeeder myTwoLinesPosFeeder = new TwoLinesPosFeeder();
        boolean seedOpt = false;
        myTwoLinesPosFeeder.SimRunner(simulations, seedOpt);
        System.out.println("---TwoLinesPos END---");
    }
