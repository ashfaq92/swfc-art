...
//
//
// public class TwoLinesPos_feeder {
//     public static int[][] bd = {{-15, 15}, {-15, 15}, {-15, 15}, {-15, 15}, {-15, 15}, {-15, 15}, {-15, 15}, {-15, 15}};
...
//             f_measure++;
//         } while (!myTwoLinesPos.producesError(d1, d2, d3, d4, d5, d6, d7, d8));
//         return f_measure;
//     }
//
...
//             if (myTwoLinesPos.producesError(d1, d2, d3, d4, d5, d6, d7, d8)) {
//                 break;
//             }
...
//         int f_measure;
//         long f_time;
//         String fileName = "twoLinesPos.txt";
