...
public class LineFeeder {
    ...
    public static double theta = 0.000303;
    private static Line myLine = new Line();
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("LineRT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("LineFSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("LineLimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("LineHNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        LineFeeder myLineFeeder = new LineFeeder();
