...
public class ComplexFeeder {
    public static double[][] bd = { {-20, 20},{-20, 20},{-20, 20},{-20, 20},{-20, 20},{-20, 20} };
    public static int d1, d2, d3, d4, d5, d6;
    public static double theta = 0.000901;
    private static Complex myComplex = new Complex();
    ...
    private static long[] randomTesting(long mySeed, BufferedWriter writer) throws IOException {
        ...
        while (true) {
            ...
            boolean revealFailure = myComplex.producesError(d1, d2, d3, d4, d5, d6);
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("ComplexRT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("ComplexFSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("ComplexLimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("ComplexHNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        ComplexFeeder myComplexFeeder = new ComplexFeeder();
        boolean seedOpt = false;
        myComplexFeeder.SimRunner(simulations, seedOpt);
