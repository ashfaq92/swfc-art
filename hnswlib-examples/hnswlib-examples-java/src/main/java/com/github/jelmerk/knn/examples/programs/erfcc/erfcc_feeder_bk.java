...
//
//
// public class erfcc_feeder_bk {
//     public static double[] min = {-30000};
//     public static double[] max = {30000};
//     public static int[][] bd = {{-30000, 30000}};
...
//         int f_measure = 1;
//         while (mySender.erfcc(tc) == mySender.erfccm(tc)) {
//             f_measure++;
...
//         if (mySender.erfcc(tcP[0].vector[0]) != mySender.erfcc(tcP[0].vector[0])) {
//             return generatedNum;
//         }
//         do {
...
//             if (mySender.erfcc(x) != mySender.erfccm(x)) {
//                 break;
//             }
...
//
//         if (mySender.erfcc(p.vector[0]) != mySender.erfccm(p.vector[0])) {
//             return kdfc.size;
//         }
//
//         Point finalCase;
...
//         erfcc_feeder_bk PogramInstance = new erfcc_feeder_bk();
//         Sender mySender = (Sender) Native.load(DLL_PATH, Sender.class);
//
//         int selected;
