package com.github.jelmerk.knn.examples.programs.cel;
...
public class CelFeeder {
    public static double[][] bd = {{0.001, 1}, {0.001, 300}, {0.001, 10000}, {0.001, 1000}};
    public static double theta = 0.000332;
    public static String DLL_PATH = "C:\\Users\\Muhammad Ashfaq\\OneDrive\\Programming\\hnswlib-master-java\\hnswlib-examples\\hnswlib-examples-java\\src\\main\\java\\com\\github\\jelmerk\\knn\\examples\\programs\\cel\\dpt_cel.dll";
    ...
    private static long[] randomTesting(long mySeed, BufferedWriter writer) throws IOException {
        ...
        while (true) {
            ...
            boolean revealFailure = mySender.Produces_Error(d1, d2, d3, d4);
    ...
    public static long[] fscsTesting(long mySeed, BufferedWriter writer) throws IOException {
        ...
        while (true) {
            ...
            d4 = tcP[(int) (fMeasure - 1)].vector[3];
    ...
    public static long[] hnswTesting(int ef, long mySeed, BufferedWriter writer) throws InterruptedException, IOException {
        ...
        while (true) {
            ...
            d1 = candP[selected].vector[0];
            d2 = candP[selected].vector[1];
            d3 = candP[selected].vector[2];
            d4 = candP[selected].vector[3];
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("CelRT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("CelFSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("CelLimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("CelHNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        CelFeeder myCelFeeder = new CelFeeder();
        boolean seedOpt = false;
        myCelFeeder.SimRunner(simulations, seedOpt);
