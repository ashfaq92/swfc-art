...
//
//
// public class bessj_feeder_bk {
//     public static double[] min = {2, -1000};
//     public static double[] max = {300, 15000};
...
//         if (mySender.original_fn(x, y) != mySender.modified_fn(x, y)) {
//             return generatedNum;
//         }
//         do {
...
//         bessj_feeder_bk PogramInstance = new bessj_feeder_bk();
//         Sender mySender = (Sender) Native.load(DLL_PATH, Sender.class);
//
//         int selected;
