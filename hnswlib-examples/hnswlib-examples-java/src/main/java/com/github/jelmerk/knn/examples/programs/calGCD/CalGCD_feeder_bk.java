...
// import com.github.jelmerk.knn.examples.programs.nearestDistance.NearestDistance;
...
//
//
// public class CalGCD_feeder_bk {
//     public static int[][] bd = {{1, 1000}, {1, 1000}, {1, 1000}, {1, 1000}, {1, 1000},
...
//     private static CalGCD myCalGCS = new CalGCD();
//
...
//             f_measure++;
//         } while (!myCalGCS.producesError(d1, d2, d3, d4, d5, d6, d7, d8, d9, d10));
//         return f_measure;
//     }
//
...
//             if (myCalGCS.producesError(d1, d2, d3, d4, d5, d6, d7, d8, d9, d10)) {
//                 break;
//             }
