...
public class TcasFeeder {
    private static double[][] bd = {{0, 1000}, {-500000, 500000}, {-500000, 500000}, {0, 50000}, {0, 1000}, {0, 50000},
            {0, 3}, {0, 1000}, {0, 1000}, {0, 2}, {0, 2}, {-500000, 500000}};
    private static int d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11, d12;
    ...
    private static long[] randomTesting(long mySeed, BufferedWriter writer) throws Exception {
        ...
        while (true) {
            ...
            d12 = (int) tc.vector[11];
            start = System.nanoTime();
            boolean revealFailure = myTcas.producesError(d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11, d12);
    ...
    public static long[] fscsTesting(long mySeed, BufferedWriter writer) throws Exception {
        ...
        while (true) {
            ...
            d12 = (int) tcP[(int) (fMeasure - 1)].vector[11];
            start = System.nanoTime();
            boolean revealFailure = myTcas.producesError(d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11, d12);
            execTime = execTime + (System.nanoTime() - start);
            if (revealFailure) {
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws Exception {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("TcasRT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("TcasFSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("TcasLimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("TcasHNSW"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        TcasFeeder myTcasFeeder = new TcasFeeder();
        boolean seedOpt = false;
        myTcasFeeder.SimRunner(simulations, seedOpt);
        System.out.println("---Tcas END---");
    }
