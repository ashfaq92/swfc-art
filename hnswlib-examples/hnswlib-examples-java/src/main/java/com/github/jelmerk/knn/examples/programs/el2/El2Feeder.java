package com.github.jelmerk.knn.examples.programs.el2;
...
public class El2Feeder {
    public static double[][] bd = {{0, 250}, {0, 250}, {0, 250}, {0, 250}};
    public static double theta = 0.000690;
    public static String DLL_PATH = "C:\\Users\\Muhammad Ashfaq\\OneDrive\\Programming\\hnswlib-master-java\\hnswlib-examples\\hnswlib-examples-java\\src\\main\\java\\com\\github\\jelmerk\\knn\\examples\\programs\\el2\\dpt_el2.dll";
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("El2RT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("El2FSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("El2LimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("El2HNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        El2Feeder myEl2Feeder = new El2Feeder();
        boolean seedOpt = false;
        myEl2Feeder.SimRunner(simulations, seedOpt);
