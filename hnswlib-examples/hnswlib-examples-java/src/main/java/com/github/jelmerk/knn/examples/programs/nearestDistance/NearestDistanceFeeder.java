...
public class NearestDistanceFeeder {
    private static double[][] bd = {{1, 15}, {1, 15}, {1, 15}, {1, 15}, {1, 15}, {1, 15}, {1, 15}, {1, 15}, {1, 15}, {1, 15}};
    private static int d1, d2, d3, d4, d5, d6, d7, d8, d9, d10;
    public static double theta = 0.000256;
    private static NearestDistance myNearestDistance = new NearestDistance();
    ...
    private static long[] randomTesting(long mySeed, BufferedWriter writer) throws IOException {
        ...
        while (true) {
            ...
            boolean revealFailure = myNearestDistance.producesError(d1, d2, d3, d4, d5, d6, d7, d8, d9, d10);
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("NearestDistanceRT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("NearestDistanceFSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("NearestDistanceLimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("NearestDistanceHNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        NearestDistanceFeeder myNearestDistanceFeeder = new NearestDistanceFeeder();
        boolean seedOpt = false;
        myNearestDistanceFeeder.SimRunner(simulations, seedOpt);
