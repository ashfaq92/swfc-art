package com.github.jelmerk.knn.examples.programs.binomial;
...
public class BinomialFeeder {
    private static double[][] bd = {{0, 1028}, {0, 1028}};
    private static double theta = 0.0001341;
    ...
    private void getFailureRate() {
        ...
        for (int i = 0; i <= iterations; i++) {
            ...
            while (true) {
                ...
                double original_output = MathUtils.binomialCoefficientDouble(d1, d2);
                double mutated_output = MathUtils.binomialCoefficientDouble_m(d1, d2);
    ...
    private long[] randomTesting(long mySeed, BufferedWriter writer) throws IOException {
        ...
        while (true) {
            ...
            double original_output = MathUtils.binomialCoefficientDouble((int) x, (int) y);
            double mutated_output = MathUtils.binomialCoefficientDouble_m((int) x, (int) y);
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("BinomialRT.txt"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("BinomialFSCS.txt"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("BinomialLimBalKdfc.txt"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("BinomialHNSW.txt"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        BinomialFeeder myBinomialFeeder = new BinomialFeeder();
        boolean seedOpt = false;
        myBinomialFeeder.SimRunner(simulations, seedOpt);
