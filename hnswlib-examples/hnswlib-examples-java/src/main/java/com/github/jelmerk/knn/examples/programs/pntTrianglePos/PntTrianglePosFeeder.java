...
public class PntTrianglePosFeeder {
    public static double[][] bd = {{-10, 10}, {-10, 10}, {-10, 10}, {-10, 10}, {-10, 10}, {-10, 10}, {-10, 10}, {-10, 10}};
    ...
    private static long[] randomTesting(long mySeed, BufferedWriter writer) throws IOException {
        ...
        while (true) {
            ...
            boolean revealFailure = myPntTrianglePos.producesError(d1, d2, d3, d4, d5, d6, d7, d8);
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("PntTrianglePosRT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("PntTrianglePosFSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("PntTrianglePosLimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("PntTrianglePosHNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        PntTrianglePosFeeder myPntTrianglePosFeeder = new PntTrianglePosFeeder();
        boolean seedOpt = false;
        myPntTrianglePosFeeder.SimRunner(simulations, seedOpt);
