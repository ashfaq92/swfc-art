package com.github.jelmerk.knn.examples.programs.bessj;
...
public class bessj_feeder {
    public static int[][] bd = {{2, 300}, {-1000, 15000}};
    public static double theta = 0.000716;
    public static String DLL_PATH = "C:\\Users\\Muhammad Ashfaq\\OneDrive\\Programming\\hnswlib-master-java\\hnswlib-examples\\hnswlib-examples-java\\src\\main\\java\\com\\github\\jelmerk\\knn\\examples\\programs\\bessj\\dpt_bessj.dll";
    ...
    private static long[] randomTesting(long mySeed, BufferedWriter writer) throws IOException {
        ...
        while (true) {
            ...
            boolean revealFailure = mySender.original_fn(x, y) != mySender.modified_fn(x, y);
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("BessjRT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("BessjFSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("BessjLimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("BessjHNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        bessj_feeder myBessjFeeder = new bessj_feeder();
        boolean seedOpt = false;
        myBessjFeeder.SimRunner(simulations, seedOpt);
