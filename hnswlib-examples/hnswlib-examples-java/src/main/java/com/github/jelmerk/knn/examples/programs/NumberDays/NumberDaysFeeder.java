...
public class NumberDaysFeeder {
    public static double[][] bd = {{1, 31}, {1, 12}, {2000, 2100}, {1, 31}, {1, 12}, {2000, 2100}};
    ...
    private static long[] randomTesting(long mySeed, BufferedWriter writer) throws IOException {
        ...
        while (true) {
            ...
            boolean revealFailure = mySender.Produces_Error(d1, d2, d3, d4, d5, d6);
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("NumberDaysRT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("NumberDaysFSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("NumberDaysKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("NumberDaysHNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        NumberDaysFeeder myLineFeeder = new NumberDaysFeeder();
        boolean seedOpt = false;
        myLineFeeder.SimRunner(simulations, seedOpt);
        System.out.println("---NumberDays END---");
    }
