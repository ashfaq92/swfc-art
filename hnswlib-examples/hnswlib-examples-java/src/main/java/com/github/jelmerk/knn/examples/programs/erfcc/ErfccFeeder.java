package com.github.jelmerk.knn.examples.programs.erfcc;
...
public class ErfccFeeder {
    public static double[][] bd = {{-30000, 30000}};
    public static double theta = 0.000574;
    public static String DLL_PATH = "C:\\Users\\Muhammad Ashfaq\\OneDrive\\Programming\\hnswlib-master-java\\hnswlib-examples\\hnswlib-examples-java\\src\\main\\java\\com\\github\\jelmerk\\knn\\examples\\programs\\erfcc\\dpt_erfcc.dll";

    public interface Sender extends Library {
        double erfcc(double n);

        double erfccm(double n);
    }
    ...
    private static long[] randomTesting(long mySeed, BufferedWriter writer) throws IOException {
        ...
        while (true) {
            ...
            boolean revealFailure = mySender.erfcc(x) != mySender.erfccm(x);
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("ErfccRT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("ErfccFSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("ErfccLimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("ErfccHNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        ErfccFeeder myErfccFeeder = new ErfccFeeder();
        boolean seedOpt = false;
        myErfccFeeder.SimRunner(simulations, seedOpt);
