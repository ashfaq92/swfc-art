...
public class GammqFeeder {
    public static double[][] bd = {{0, 1700}, {0, 40}};
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("GammqRT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("GammqFSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("GammqLimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("GammqHNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        System.out.println("---Gammq START---");
        int simulations = 10000;
        GammqFeeder myGammqFeeder = new GammqFeeder();
        boolean seedOpt = false;
        myGammqFeeder.SimRunner(simulations, seedOpt);
        System.out.println("---Gammq END---");
    }
