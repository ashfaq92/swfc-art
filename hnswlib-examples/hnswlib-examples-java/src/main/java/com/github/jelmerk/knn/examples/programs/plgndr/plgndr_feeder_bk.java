...
//
//
// public class plgndr_feeder_bk {
//     public static double[] min = {10, 0, 0};
//     public static double[] max = {500, 11, 1};
...
//         if (mySender.Produces_Error(x, y, z)) {
//             return generatedNum;
//         }
//         do {
...
//         plgndr_feeder_bk PogramInstance = new plgndr_feeder_bk();
//         Sender mySender = (Sender) Native.load(DLL_PATH, Sender.class);
//
//         int selected;
