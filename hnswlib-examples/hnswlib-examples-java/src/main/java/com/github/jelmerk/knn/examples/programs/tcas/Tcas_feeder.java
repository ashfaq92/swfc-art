...
// import com.github.jelmerk.knn.examples.programs.select.Select;
...
//
//
// public class Tcas_feeder {
//     public static int[][] bd = { {0,1000}, {-500000,500000}, {-500000,500000}, {0,50000},{0,1000},{0,50000},
//                                  {0,3},{0,1000},{0,1000},{0,2},{0,2},{-500000,500000} };
//     public static int Dimension = 12;
//     public static int d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11, d12;
//
//     public static double theta = 0.0001;
//     private static Tcas myTcas = new Tcas();
//
//     public static int randomTesting() throws Exception {
//         int f_measure = 1;
//         do {
...
//             d9 = bd[8][0] + (int) (Math.random() * ((bd[8][1] - bd[8][0]) + 1));
//             d10 = bd[9][0] + (int) (Math.random() * ((bd[9][1] - bd[9][0]) + 1));
//             d11 = bd[10][0] + (int) (Math.random() * ((bd[10][1] - bd[10][0]) + 1));
//             d12 = bd[11][0] + (int) (Math.random() * ((bd[11][1] - bd[11][0]) + 1));
//             f_measure++;
//         } while (!myTcas.producesError(d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11, d12));
//         return f_measure;
//     }
//
//     public static int fscsTesting() throws Exception {
...
//             d9 = (int) tcP[generatedNum - 1].coordPoint[8];
//             d10 = (int) tcP[generatedNum - 1].coordPoint[9];
//             d11 = (int) tcP[generatedNum - 1].coordPoint[10];
//             d12 = (int) tcP[generatedNum - 1].coordPoint[11];
//             // System.out.println(tcP[generatedNum - 1].toString());
//             if (myTcas.producesError(d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11, d12)) {
//                 break;
//             }
...
//     }
//
//     public static int limBalKdfcTesting() throws Exception {
...
//             d9 = (int) finalCase.coordPoint[8];
//             d10 = (int) finalCase.coordPoint[9];
//             d11 = (int) finalCase.coordPoint[10];
//             d12 = (int) finalCase.coordPoint[11];
//             // System.out.println(d2);
//             // System.out.println(d2);
//             // System.out.println(d12);
//             // System.out.println(finalCase.toString());
//         } while (!myTcas.producesError(d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11, d12));
//         return kdfc.size;
//     }
//
//     public static int hnswTesting(int ef) throws Exception {
...
//             d12 = (int) candP[selected].vector[11];
