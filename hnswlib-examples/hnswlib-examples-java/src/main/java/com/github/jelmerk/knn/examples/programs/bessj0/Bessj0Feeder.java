...
public class Bessj0Feeder {
    public static int[][] bd = {{-300000, 300000}};
    public static double theta = 0.001373;
    public static String DLL_PATH = "C:\\Users\\Muhammad Ashfaq\\OneDrive\\Programming\\hnswlib-master-java-internetware\\hnswlib-examples\\hnswlib-examples-java\\src\\main\\java\\com\\github\\jelmerk\\knn\\examples\\programs\\bessj0\\dpt_bessj0.dll";
    ...
    private static long[] randomTesting(long mySeed, BufferedWriter writer) throws IOException {
        ...
        while (true) {
            ...
            boolean revealFailure = mySender.bessj0(x) != mySender.bessj0m(x);
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("Bessj0RT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("Bessj0FSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("Bessj0LimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("Bessj0HNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        Bessj0Feeder myBessj0Feeder = new Bessj0Feeder();
        boolean seedOpt = false;
        myBessj0Feeder.SimRunner(simulations, seedOpt);
