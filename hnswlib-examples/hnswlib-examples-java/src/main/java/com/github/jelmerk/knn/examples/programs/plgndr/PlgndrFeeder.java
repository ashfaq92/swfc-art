package com.github.jelmerk.knn.examples.programs.plgndr;
...
public class PlgndrFeeder {
    public static int[][] bd = {{10, 500}, {0, 11}, {0, 1}};
    public static double theta = 0.000368;
    public static String DLL_PATH = "C:\\Users\\Muhammad Ashfaq\\OneDrive\\Programming\\hnswlib-master-java\\hnswlib-examples\\hnswlib-examples-java\\src\\main\\java\\com\\github\\jelmerk\\knn\\examples\\programs\\plgndr\\dpt_plgndr.dll";
    ...
    private void SimRunner(int sim, boolean withSameSeed) throws InterruptedException, IOException {
        BufferedWriter RTwriter = new BufferedWriter(new FileWriter("PlgndrRT"));
        BufferedWriter FSCSwriter = new BufferedWriter(new FileWriter("PlgndrFSCS"));
        BufferedWriter LimBalKdfcwriter = new BufferedWriter(new FileWriter("PlgndrLimBalKdfc"));
        BufferedWriter HNSWwriter = new BufferedWriter(new FileWriter("PlgndrHNSW"));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        System.out.println("---Plgndr START---");
        int simulations = 10000;
        PlgndrFeeder myGoldenFeeder = new PlgndrFeeder();
        boolean seedOpt = false;
        myGoldenFeeder.SimRunner(simulations, seedOpt);
        System.out.println("---Plgndr END---");
    }
