...
//
//
// public class probks_feeder_bk {
//     public static double[] min = {-50000};
//     public static double[] max = {50000};
//     public static int[][] bd = {{-50000, 50000}};
...
//         int f_measure = 1;
//         while (mySender.probks(tc) == mySender.probksm(tc)) {
//             f_measure++;
...
//         if (mySender.probks(tcP[0].vector[0]) != mySender.probksm(tcP[0].vector[0])) {
//             return generatedNum;
//         }
//         do {
...
//             if (mySender.probks(x) != mySender.probksm(x)) {
//                 break;
//             }
...
//
//         if (mySender.probks(p.vector[0]) != mySender.probksm(p.vector[0])) {
//             return kdfc.size;
//         }
//
//         Point finalCase;
