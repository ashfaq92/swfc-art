...
//
//
// public class cel_feeder_bk {
//     public static double[] min = {0, 0, 0, 0};
//     public static double[] max = {1, 300, 10000, 1000};
//     public static int[][] bd = {{0, 1}, {0, 300}, {0, 10000}, {0, 1000}};
//     public static int Dimension = 4;
//     public static double theta = 0.000332;
//     public static String DLL_PATH = "C:\\Users\\Muhammad Ashfaq\\OneDrive\\Programming\\hnswlib-master-java\\hnswlib-examples\\hnswlib-examples-java\\src\\main\\java\\com\\github\\jelmerk\\knn\\examples\\programs\\cel\\dpt_cel-bk.dll";
//
...
//         double z = tcP[0].vector[2];
//         double w = tcP[0].vector[3];
//         if (mySender.Produces_Error(x, y, z, w)) {
//             return generatedNum;
//         }
//         do {
...
//             z = tcP[generatedNum - 1].vector[2];
//             w = tcP[generatedNum - 1].vector[3];
...
//             z = finalCase.vector[2];
//             w = finalCase.vector[3];
//             // System.out.println(tcP[generatedNum - 1].toString());
//             if (mySender.Produces_Error(x, y, z, w)) {
//                 break;
//             }
...
//         double z = selected_set.get(f_measure - 1).vector[2];
//         double w = selected_set.get(f_measure - 1).vector[3];
//         if (mySender.Produces_Error(x, y, z, w)) {
//             return f_measure;
//         }
//
...
//             z = selected_set.get(f_measure - 1).vector[2];
//             w = selected_set.get(f_measure - 1).vector[3];
